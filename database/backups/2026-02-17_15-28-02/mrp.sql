...
\restrict h0Ag7nRQjEm47d5pGw7agShMwH2blyH2YfoiMWBMMhudbk0QKnPKN2Focd5VtKy
...
CREATE TABLE public.compras (
    ...
    cantidad numeric(15,2) DEFAULT 1 NOT NULL,
...
COPY public.compras (id, id_variante, fecha, precio_unitario, cantidad, proveedor, observaciones, created_at, updated_at) FROM stdin;
1	156	2026-02-17	3500.00	100.00		[Auto] Compra original: 100.00 m a $350000.00 (Total). Factor: 1	2026-02-17 14:49:20.689331	2026-02-17 14:49:20.689331
\.
...
5	4	1	t	Recepci??n de materiales de proveedor	2026-02-15 19:50:11.280201	2026-02-15 19:50:11.280201
14	4	6	t	Ajuste de inventario - salida	2026-02-15 19:50:11.400848	2026-02-15 19:50:11.400848
...
182	183	ROJO	cuero rojo pardo	activa	1.00	2.00	0.00	0	0	0.00	10.0000	88	\N	{}	\N	2026-02-17 14:56:18.744268+00	2026-02-17 15:01:23.215006+00	0.00
184	183	AZUL	cuero azul africano	activa	1.00	2.00	0.00	0	0	0.00	1.0000	88	\N	{}	\N	2026-02-17 15:05:48.772392+00	2026-02-17 15:05:48.772392+00	0.00
...
SELECT pg_catalog.setval('public.tipos_depositos_movimientos_id_seq', 35, true);
...
SELECT pg_catalog.setval('public.unidades_medida_id_seq', 100, true);
...
--
-- Name: idx_compras_variante_fecha; Type: INDEX; Schema: public; Owner: mrp
--

CREATE INDEX idx_compras_variante_fecha ON public.compras USING btree (id_variante, fecha DESC);
...
--
-- Name: compras fk_compras_variante; Type: FK CONSTRAINT; Schema: public; Owner: mrp
--

ALTER TABLE ONLY public.compras
    ADD CONSTRAINT fk_compras_variante FOREIGN KEY (id_variante) REFERENCES public.variantes(id) ON DELETE CASCADE;
...
\unrestrict h0Ag7nRQjEm47d5pGw7agShMwH2blyH2YfoiMWBMMhudbk0QKnPKN2Focd5VtKy
