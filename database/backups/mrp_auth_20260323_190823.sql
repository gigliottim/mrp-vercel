...
\restrict yLta5NKNpQhpYnlSf4QAQrh4oTk9bX2IMner3t7W2XOdALk5NvY2nPSrFs66ocJ
...
--
-- Name: fn_super_admin_auto_link(); Type: FUNCTION; Schema: public; Owner: mrp_unik_2026
--
...
ALTER FUNCTION public.fn_super_admin_auto_link() OWNER TO mrp_unik_2026;
...
4	super_admin	web	2026-03-12 12:50:17.995816+00	2026-03-12 12:50:17.995816+00
5	usuario	company:1:usr	2026-03-16 22:15:29.003962+00	2026-03-16 22:17:14.179142+00
6	Operador	company:2:Operador	2026-03-23 20:18:41.179502+00	2026-03-23 20:18:41.179502+00
7	Usuario	company:2:Usuario	2026-03-23 20:18:56.634185+00	2026-03-23 20:18:56.634185+00
1	Administrador	company:2:Administrador	2026-02-11 18:04:52.89919+00	2026-03-23 20:19:47.073304+00
\.
...
4	Martin Gigliotti	martin@unik.ar	$2y$12$w23SYIWHYeIi3x8fM43clOfP39ND8k01Oh538kgpfsJy1jZRegFWy	f	\N	\N	\N	\N	2026-03-12 12:50:18.428058+00	2026-03-12 12:50:18.428058+00
\.
...
SELECT pg_catalog.setval('public.menu_acl_id_seq', 6, true);
...
--
-- Name: companies trg_super_admin_auto_link; Type: TRIGGER; Schema: public; Owner: mrp
--
...
--
-- Name: TABLE audit_logs; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.audit_logs TO mrp_unik_2026;


--
-- Name: SEQUENCE audit_logs_id_seq; Type: ACL; Schema: public; Owner: mrp
--

GRANT ALL ON SEQUENCE public.audit_logs_id_seq TO mrp_unik_2026;


--
-- Name: TABLE companies; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.companies TO mrp_unik_2026;


--
-- Name: SEQUENCE companies_id_seq; Type: ACL; Schema: public; Owner: mrp
--

GRANT ALL ON SEQUENCE public.companies_id_seq TO mrp_unik_2026;


--
-- Name: TABLE company_databases; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.company_databases TO mrp_unik_2026;


--
-- Name: SEQUENCE company_databases_id_seq; Type: ACL; Schema: public; Owner: mrp
--

GRANT ALL ON SEQUENCE public.company_databases_id_seq TO mrp_unik_2026;


--
-- Name: TABLE menu_acl; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.menu_acl TO mrp_unik_2026;


--
-- Name: SEQUENCE menu_acl_id_seq; Type: ACL; Schema: public; Owner: mrp
--

GRANT ALL ON SEQUENCE public.menu_acl_id_seq TO mrp_unik_2026;


--
-- Name: TABLE menu_items; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.menu_items TO mrp_unik_2026;


--
-- Name: SEQUENCE menu_items_id_seq; Type: ACL; Schema: public; Owner: mrp
--

GRANT ALL ON SEQUENCE public.menu_items_id_seq TO mrp_unik_2026;


--
-- Name: TABLE permissions; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.permissions TO mrp_unik_2026;


--
-- Name: SEQUENCE permissions_id_seq; Type: ACL; Schema: public; Owner: mrp
--

GRANT ALL ON SEQUENCE public.permissions_id_seq TO mrp_unik_2026;


--
-- Name: TABLE personal_access_tokens; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.personal_access_tokens TO mrp_unik_2026;


--
-- Name: SEQUENCE personal_access_tokens_id_seq; Type: ACL; Schema: public; Owner: mrp
--

GRANT ALL ON SEQUENCE public.personal_access_tokens_id_seq TO mrp_unik_2026;


--
-- Name: TABLE role_has_permissions; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.role_has_permissions TO mrp_unik_2026;


--
-- Name: TABLE roles; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.roles TO mrp_unik_2026;


--
-- Name: SEQUENCE roles_id_seq; Type: ACL; Schema: public; Owner: mrp
--

GRANT ALL ON SEQUENCE public.roles_id_seq TO mrp_unik_2026;
...
--
-- Name: TABLE user_company; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.user_company TO mrp_unik_2026;


--
-- Name: TABLE user_has_roles; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.user_has_roles TO mrp_unik_2026;


--
-- Name: TABLE users; Type: ACL; Schema: public; Owner: mrp
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.users TO mrp_unik_2026;


--
-- Name: SEQUENCE users_id_seq; Type: ACL; Schema: public; Owner: mrp
--

GRANT ALL ON SEQUENCE public.users_id_seq TO mrp_unik_2026;
...
\unrestrict yLta5NKNpQhpYnlSf4QAQrh4oTk9bX2IMner3t7W2XOdALk5NvY2nPSrFs66ocJ