            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <h2 class="h5 mb-0"><?= $editing ? 'Editar usuario' : 'Nuevo usuario' ?></h2>
                    </div>
                    <?php if ($editing) : ?>
                ...
                <form
                    method="post"
                    action="<?= $editing ? url('/empresa-usuarios/usuarios/' . (int) $editing['id']) : url('/empresa-usuarios/usuarios') ?>"
                    class="vstack gap-3">
                    <?php if ($editing) : ?>
                    ...
                    <div>
                        <label class="form-label" for="password">Password <?= $editing ? '(dejar vacio para mantener)' : '' ?></label>
                        <input
                            id="password"
