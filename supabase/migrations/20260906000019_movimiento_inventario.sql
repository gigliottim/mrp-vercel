-- movimiento_inventario: inserta movimiento + actualiza stock en una transacción
-- SECURITY DEFINER: el trigger actualizar_stock_trigger (UPDATE sobre variantes)
-- corre como el rol definer, sin fricción con RLS.
